  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
    ...
    <div class="row my-4" >
        ...
        <div class="card" style="width:146.5% ; padding:20px ; padding-top:60px ;height:90px " >
            <span class="font-weight-bolder mb-0"style="text-align:center; margin-top:-37px; font-size:30px"> Appointment Table</span>
        </div>
            @endif
        </div>
    </div> 
                    ...
                    <tr>
                      ...
                      <td style="text-align:center">
                        <span class="text-xs font-weight-bold" >
                            ...
                            <a class="btn btn-danger" href="{{route('admin.cancelAppointment', $item->id)}}">cancel</a>
                            @endif
                            @if($item->statut=='canceld') 
                            <a class="btn btn-success" href="{{route('admin.approveAppointment', $item->id)}}">approve</a>
                            @endif
                      ...
                      <td style="text-align:center">
                        <span class="text-xs font-weight-bold" >
                          <a class="btn btn-danger" href="{{route('admin.deleteAppointment', $item->id)}}">X</a>
                        </span>    
                      </td>
