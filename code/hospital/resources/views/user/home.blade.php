...
<body>
  ...
  <div class="row my-4" >
        <div class="col-lg-8 col-md-6 mb-md-0 mb-4" >
            ...
            <div class="alert alert-success" style="width:100vw; text-align:center">
                {{session()->get('message')}}
            </div>
            @endif
            @if(session()->has('error'))
            <div class="alert alert-danger" style="width:100vw; text-align:center">
                {{session()->get('error')}}
            </div>
            @endif
        </div>
  ...
  <div class="page-hero bg-image overlay-dark" style="background-image: url(../assets/img/g.jpg);">
    <div class="hero-section">
      <div class="container text-center wow zoomIn">
        <span class="subhead">Let's make your life happier</span>
        <h1 class="display-4">Healthy Living</h1>
        <a href="#makeAppointment" class="btn btn-primary">Let's Consult</a>
      </div>
    </div>
  </div>
